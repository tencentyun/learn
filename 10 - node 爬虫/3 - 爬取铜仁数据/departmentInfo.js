...
var themeValues = '教育局';
var url = 'http://www.gzegn.gov.cn/permissionitem/009550260.jspx';
...
function filterHtml(html){
    ...
    $('.shouli_table_style').each(function (index,value){
        ...
        var titleText = $(this);
        // 遍历小标题
        $(this).find('.tr_hover').each(function (index,value){
            // 获取大标题
            var bigTitle = titleText.children('thead').children('tr').children('th').text();
            // 获取小标题
