...
var url = 'http://www.gzegn.gov.cn/permissionitem_list_Sort.jspx?sortcode=001001012&areaid=520600';
...
function contentFun(sum){
    ...
    $('.tagContent').each(function (index,value){
        if($('.tagContent')[index] == $('.tagContent')[0] || $('.tagContent')[index] == $('.tagContent')[3]){
            // 基本信息
        ...
        http.get(smallLink,function (res){
            ...
            res.on('end',function (){
                ...
                var formData = {
                    ...
                    "statutory_acc1":"",          // 特殊环节名称
                    "acc_describe1":"",          // 环节是否收费
                    "statutory_acc2":"",          // 环节实施依据及描述
                    "acc_describe2":""         // 环节收费依据及描述
                };
                 创建数据库连接
